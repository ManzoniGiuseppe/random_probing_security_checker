...
T__THREAD_SAFE void transformGenerator_getTranform(transformGenerator_t storage, rowHash_t row, number_t *ret); // ret contains  1ll << numMaskedIns  blocks of  NUM_SIZE(numTotIns+3)  num_t
